...
const ProjectBox = ({ projectPhoto, projectName }: { projectPhoto: StaticImageData, projectName: string }) => {
    ...
    return (
        <div className='projectBox'>
            <Image className='projectPhoto' src={projectPhoto} alt={`${projectName} Display`} priority />
            <div>
                <br />
                <h3>{projectName}</h3>
                <br />
